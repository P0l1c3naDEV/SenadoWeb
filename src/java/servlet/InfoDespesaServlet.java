 ...
 * @author muril
 */
@WebServlet(name = "InfoDespesaServlet", urlPatterns = {"/InfoDespesaServlet"})
public class InfoDespesaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Despesa despesa = despesaJpa.findDespesa(id);
